...
int main() {
	...
	perm::ExplicitPermutation perm2 = perm::ExplicitPermutation(perm::DisjointCycles({ { 0, 1 }, { 1, 2 } }));
	...
	perm::ExplicitPermutation perm3 = perm::ExplicitPermutation(perm::DisjointCycles({ { 1, 3 }, { 0, 4 } }), -1);
